...
#define SETUP_AW                                                               \
  0x03 // 设置地址宽度(所有数据通道):bit1,0:00,3字节;01,4字节;02,5字节;
#define SETUP_RETR                                                             \
  0x04 // 建立自动重发;bit3:0,自动重发计数器;bit7:4,自动重发延时 250*x+86us
...
#define TX_ADDR                                                                \
  0x10 // 发送地址(低字节在前),ShockBurst模式下,RX_ADDR_P0与此地址相等
