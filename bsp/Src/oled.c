...
void OLED_WriteCommand(uint8_t Command) {
  HAL_I2C_Mem_Write(&OLED_IIC, OLED_ADDR, OLED_WRITE_MODE, I2C_MEMADD_SIZE_8BIT,
                    &Command, 1, 10);
}
...
void OLED_WriteData(uint8_t *Data, uint8_t Count) {
  HAL_I2C_Mem_Write(&OLED_IIC, OLED_ADDR, OLED_WRITE_DATA,
                        I2C_MEMADD_SIZE_8BIT, Data, Count,10);
}
 ...
 */
void OLED_Init(void) {
  uint8_t data[23] = {0xAE, 0xD5, 0x80, 0xA8, 0x3F, 0xD3, 0x00, 0x40,
                      0xA1, 0xC8, 0xDA, 0x12, 0x81, 0xCF, 0xD9, 0xF1,
                      0xDB, 0xDB, 0xA4, 0xA6, 0x8D, 0x14, 0xAF};
